document.addEventListener('DOMContentLoaded', function () {
    ...
    const initialProjects = [
        { name: 'RFG-Hybrid-SecuritySuit', description: 'Advanced AI-powered security suite for vulnerability analysis. Features OSINT (Shodan/Censys), automated scanning, and AI model security audits.', image_url: 'assets/RFG-HYB.jpg', github_link: 'https://github.com/rauffathigovashin/RFG-Hybrid-SecuritySuit', tags: ['Python', 'Cybersecurity', 'AI'] },
        { name: 'VirtualBox-DCRP-Python-Project', description: 'VirtualBox rich presence for discord using python programming language.', image_url: 'assets/74278f41-virtualbox.png', github_link: 'https://github.com/rauffathigovashin/VirtualBox-DCRP-Python-Project', tags: ['Python', 'Discord RPC'] },
        { name: 'WebsiteCrawler-Spider-', description: 'A program that can bring all links from site using python BeautifulSoup4 and request library.', image_url: 'assets/web-crawlers.png', github_link: 'https://github.com/rauffathigovashin/WebsiteCrawler-Spider-', tags: ['Python', 'Web Scraping'] },
        { name: 'SubdomainFinder', description: 'Simple subdomain finder using serpapi with requests, urllib.urlparse and os library.', image_url: 'assets/subdomain_scanner.png', github_link: 'https://github.com/rauffathigovashin/SubdomainFinder', tags: ['Python', 'OSINT'] },
        { name: 'ARP-Spoof-ManintheMiddle', description: 'Python script demonstrating ARP spoofing principles for network security education.', image_url: 'assets/ARP.jpg', github_link: 'https://github.com/rauffathigovashin/ARP-Spoof-ManintheMiddle', tags: ['Python', 'Cybersecurity'] },
        { name: 'CatchTheCircle', description: 'Basic game using python turtle library.', image_url: 'assets/circle.jpg', github_link: 'https://github.com/rauffathigovashin/CatchTheCircle', tags: ['Python', 'Game'] },
        { name: 'SecretNotesPy', description: 'Note encryption and decryption software developed using python.', image_url: 'assets/secretnotes.jpg', github_link: 'https://github.com/rauffathigovashin/SecretNotesPy', tags: ['Python', 'Cryptography'] },
        { name: 'MacChangerLinux', description: 'A simple program that changes Mac address in linux with -i and -m commands.', image_url: 'assets/MacChanger.jpg', github_link: 'https://github.com/rauffathigovashin/MacChangerLinux', tags: ['Python', 'Cybersecurity'] },
        { name: 'NetworkScanningTool', description: 'Basic network scanner tool using python. usage --ip 10.0.2.1/24', image_url: 'assets/NetworkScanner.jpg', github_link: 'https://github.com/rauffathigovashin/NetworkScanningTool', tags: ['Python', 'Networking'] },
        { name: 'BufferOverflowExp', description: 'An exploit in python for hacking vulnserver only educational purposes.', image_url: 'assets/Bufferoverflow.jpg', github_link: 'https://github.com/rauffathigovashin/BufferOverflowExp', tags: ['Python', 'Exploit Dev'] },
        { name: 'YoutubeDownloader', description: 'A simple Python tool that lets you download YouTube videos and thumbnails.', image_url: 'assets/Youtube.png', github_link: 'https://github.com/rauffathigovashin/YoutubeDownloader', tags: ['Python'] },
        { name: 'Text-to-Speech', description: 'A program that turns given text to speech.', image_url: 'assets/texttospeech.png', github_link: 'https://github.com/rauffathigovashin/Text-to-Speech', tags: ['Python'] },
        { name: 'BMICalculator', description: 'Simple calculator for calculating your BMI using tkinter.', image_url: 'assets/BMICalc.png', github_link: 'https://github.com/rauffathigovashin/BMICalculator', tags: ['Python', 'Tkinter'] },
        { name: 'MyWeatherApp', description: 'Weather Website using Weather API, Flask, and JS.', image_url: 'assets/WeatherAPP.jpg', github_link: 'https://github.com/rauffathigovashin/MyWeatherApp', tags: ['Python', 'Flask', 'Web'] },
        { name: 'ArtBookJava', description: 'ArtBook is a simple Android app for adding artworks.', image_url: 'assets/artbook.png', github_link: 'https://github.com/rauffathigovashin/ArtBookJava', tags: ['Java', 'Android'] },
        { name: 'CyberRFG-Portfolio', description: 'Animated portfolio site using HTML, CSS, and JS.', image_url: 'assets/CyberRFG.png', github_link: 'https://github.com/rauffathigovashin/CyberRFG-Portfolio', tags: ['HTML', 'CSS', 'JS'] }
    ];
